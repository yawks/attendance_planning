...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar p-3 [--cell-size:2rem] [[data-slot=card-co\
ntent]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
...
-1",
        ...
        button_previous: cn(
          ...
          "h-[--cell-size] w-[--cell-size] select-none p-0 aria-disabled:opacity\
-50",
...
-50",
        ...
        month_caption: cn(
          "flex h-[--cell-size] w-full items-center justify-center px-[--cell-si\
ze]",
...
sm font-medium",
        ...
        dropdown_root: cn(
          "has-focus:border-ring border-input shadow-xs has-focus:ring-ring/50 h\
as-focus:ring-[3px] relative rounded-md border",
...
-md pl-2 pr-1 text-sm [&>svg]:size-3.5",
          defaultClassNames.caption_label
        ),
        table: "w-full border-collapse",
        weekdays: cn("flex", defaultClassNames.weekdays),
        weekday: cn(
          "text-muted-foreground flex-1 select-none rounded-md text-[0.8rem] fon\
t-normal",
        ...
        day: cn(
          "group/day relative aspect-square h-full w-full select-none p-0 text-c\
enter [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data\
-selected=true]_button]:rounded-r-md",
...
ded-none",
      ...
      components={{
        ...
        WeekNumber: ({ children, ...props }) => {
          return (
            <td {...props}>
              <div className="flex size-[--cell-size] items-center justify-cente\
r text-center">
                {children}
              </div>
            </td>
